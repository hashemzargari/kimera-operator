...
// DevelopmentEnvironmentReconciler reconciles a DevelopmentEnvironment object
type DevelopmentEnvironmentReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=platform.kimera.dev,resources=developmentenvironments,verbs=get;list;watch;create;update;patch;delete
...
// the DevelopmentEnvironment object against the actual cluster state, and then
